...
public class ListaCustomers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        entityManager = java.beans.Beans.isDesignTime() ? null : javax.persistence.Persistence.createEntityManagerFactory("sergiobd?zeroDateTimeBehavior=convertToNullPU").createEntityManager();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaCustomers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private java.util.List<vistaSergioBank.Customer> customerList;
    private java.util.List<vistaSergioBank.Customer> customerList1;
    private java.util.List<vistaSergioBank.Customer> customerList2;
